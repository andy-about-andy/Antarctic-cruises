...
/* harmony import */ var _modules_burger_menu_burger_menu__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/burger-menu/burger-menu */ "./js/modules/burger-menu/burger-menu.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    Object(_modules_burger_menu_burger_menu__WEBPACK_IMPORTED_MODULE_1__["burger"])();
    Object(_modules_burger_menu_burger_menu__WEBPACK_IMPORTED_MODULE_1__["hidesMenu"])();
    Object(_modules_burger_menu_burger_menu__WEBPACK_IMPORTED_MODULE_1__["hidesMenuOverlay"])();
  });
});
...
/*!***********************************************!*\
  !*** ./js/modules/burger-menu/burger-menu.js ***!
  \***********************************************/
/*! exports provided: burger, hidesMenu, hidesMenuOverlay */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "burger", function() { return burger; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "hidesMenu", function() { return hidesMenu; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "hidesMenuOverlay", function() { return hidesMenuOverlay; });
var headerMain = document.querySelector('.main-header');
var navMain = document.querySelector('.main-nav');
var navToggle = document.querySelector('.main-nav__toggle');
var logo = document.querySelector('.main-header__link-logo');
var mainBlock = document.querySelector('.main-block__wrap');
var anchor = document.querySelector('.main-nav__list');
var testwrap = document.querySelector('.main-header__wrap');
var overflowMenu = document.querySelector('.main-nav__wrapper');
headerMain.classList.remove('main-header--nojs');
navMain.classList.remove('main-nav--nojs');

// Функция закрытия меню
var closesMenu = function closesMenu() {
...
var hidesMenu = function hidesMenu() {
...
var hidesMenuOverlay = function hidesMenuOverlay() {
  testwrap.addEventListener('click', function (evt) {
