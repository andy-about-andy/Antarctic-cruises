...
/*!********************!*\
  !*** ./js/main.js ***!
  \********************/
/*! no exports provided */function(e,t,n){"use strict";n.r(t);var o=n(/*! ./utils/ios-vh-fix */"./js/utils/ios-vh-fix.js"),s=n(/*! ./modules/modals/init-modals */"./js/modules/modals/init-modals.js"),i=n(/*! ./modules/burger-menu/burger-menu */"./js/modules/burger-menu/burger-menu.js");window.addEventListener("DOMContentLoaded",(function(){Object(o.iosVhFix)(),window.addEventListener("load",(function(){Object(s.initModals)(),i.burger,i.test}))}))},"./js/modules/burger-menu/burger-menu.js":
/*!***********************************************!*\
  !*** ./js/modules/burger-menu/burger-menu.js ***!
  \***********************************************/
/*! exports provided: default */function(e,t,n){"use strict";n.r(t);var o=document.querySelector(".main-header"),s=document.querySelector(".main-nav"),i=document.querySelector(".main-nav__toggle"),l=document.querySelector(".main-header__link-logo"),a=document.querySelector(".main-block__wrap"),c=document.querySelector(".main-nav__list");o.classList.remove("main-header--nojs"),s.classList.remove("main-nav--nojs");var r=i.addEventListener("click",(function(){s.classList.contains("main-nav--closed")?(s.classList.remove("main-nav--closed"),s.classList.add("main-nav--opened"),l.classList.add("main-header__link-logo--opened-mobile"),a.classList.add("main-block__wrap--opened-mobile")):(s.classList.add("main-nav--closed"),s.classList.remove("main-nav--opened"),l.classList.remove("main-header__link-logo--opened-mobile"),a.classList.remove("main-block__wrap--opened-mobile"))})),u=c.addEventListener("click",(function(){s.classList.contains("main-nav--opened")&&(s.classList.add("main-nav--closed"),s.classList.remove("main-nav--opened"),l.classList.remove("main-header__link-logo--opened-mobile"),a.classList.remove("main-block__wrap--opened-mobile"))}));t.default={burger:r,test:u}},"./js/modules/modals/init-modals.js":
/*!******************************************!*\
